...
const newToolsPath = path.join(__dirname, 'new_tools_add69.ts');
...
if (!newToolsMatch) {
  console.error('Could not find newTools array in new_tools_add69.ts');
  process.exit(1);
}
...
const updatedContent = toolsContent.slice(0, insertPosition) + 
  ...
  '  // AI for Environmental Sustainability - 10 tools\n' +
  '  // AI for Sports & Fitness - 10 tools\n' +
  '  // AI for Cybersecurity - 10 tools\n' +
  '  // AI for Education Technology - 10 tools\n' +
