...
// Read the new tools
const newToolsData = fs.readFileSync(path.join(__dirname, 'new_tools_add18.ts'), 'utf8');
...
const updatedContent = toolsContent.slice(0, insertPosition) + 
  ...
  '  // AI for Home Improvement - 10 tools\n' +
  '  // AI for Personal Finance - 10 tools\n' +
  '  // AI for Parenting - 10 tools\n' +
