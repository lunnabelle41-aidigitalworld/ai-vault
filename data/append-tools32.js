...
// Read the new tools
const newToolsData = fs.readFileSync(path.join(__dirname, 'new_tools_add32.ts'), 'utf8');
...
const updatedContent = toolsContent.slice(0, insertPosition) + 
  '  // AI for Pharmaceuticals & Biotech - 10 tools\n' +
  '  // AI for Aviation & Aerospace - 10 tools\n' +
