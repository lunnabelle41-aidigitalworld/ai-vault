...
// Read the new tools
const newToolsData = fs.readFileSync(path.join(__dirname, 'new_tools_add14.ts'), 'utf8');
...
const updatedContent = toolsContent.slice(0, insertPosition) + 
  ...
  '  // AI for Construction & Engineering - 10 tools\n' +
  '  // AI for Logistics & Supply Chain - 10 tools\n' +
  '  // AI for Utilities & Public Services - 10 tools\n' +
  '  // AI for Art & Design - 10 tools\n' +
