...
// Read the new tools
const newToolsData = fs.readFileSync(path.join(__dirname, 'new_tools_add20.ts'), 'utf8');
...
const updatedContent = toolsContent.slice(0, insertPosition) + 
  ...
  '  // AI for Telecommunications - 10 tools\n' +
  '  // AI for Mining & Resources - 10 tools\n' +
  '  // AI for Aerospace & Defense - 10 tools\n' +
  '  // AI for Maritime & Shipping - 10 tools\n' +
