...
const newToolsPath = path.join(__dirname, 'new_tools_add62.ts');
...
if (!newToolsMatch) {
    console.error('Could not find newTools array in new_tools_add62.ts');
    process.exit(1);
}
