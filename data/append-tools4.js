...
// Read the new tools
const newToolsData = fs.readFileSync(path.join(__dirname, 'new_tools_add4.ts'), 'utf8');
...
const updatedContent = toolsContent.slice(0, insertPosition) + 
  '  // AI for Smart Manufacturing - 10 tools\n' +
  '  // AI for Renewable Energy - 10 tools\n' +
  '  // AI for Cybersecurity Defense - 10 tools\n' +
  '  // AI for Digital Marketing - 10 tools\n' +
