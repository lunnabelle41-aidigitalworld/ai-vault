...
// Read the new tools
const newToolsData = fs.readFileSync(path.join(__dirname, 'new_tools_add34.ts'), 'utf8');
...
const updatedContent = toolsContent.slice(0, insertPosition) + 
  ...
  '  // AI for Manufacturing - 10 tools\n' +
  '  // AI for Gaming & Entertainment - 10 tools\n' +
  '  // AI for Government & Public Sector - 10 tools\n' +
