...
// Read the new tools
const newToolsData = fs.readFileSync(path.join(__dirname, 'new_tools_add6.ts'), 'utf8');
...
const updatedContent = toolsContent.slice(0, insertPosition) + 
  ...
  '  // AI for Language Learning - 10 tools\n' +
  '  // AI for Pet Care - 10 tools\n' +
  '  // AI for Real Estate Investment - 10 tools\n' +
  '  // AI for Sports Analytics - 10 tools\n' +
